		...
		if (loggedIn){
			...
			// REFUND
				...
				if (userType == "AA"){
					...
					int transfer = users.transferCredit(buyer, seller, amount, false);			
					...
					if (transfer == 0){
						...
						cout << "Seller doesn't have enough credit to give refund.\n";
						output << "Seller doesn't have enough credit to give refund.\n";
					}
					else if (transfer == -5){
						cout << "Buyer will have too much credit after refund.\n";
						output << "Buyer will have too much credit after refund.\n";
					}
				}
				else{
